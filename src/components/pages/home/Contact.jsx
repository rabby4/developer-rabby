    ...
    return (
        <>
            <div className='container max-w-7xl mx-auto my-32'>
                ...
                <div className='grid grid-cols-3 gap-10 justify-between  my-10'>
                    ...
                    <div className='col-span-2 w-full p-10 rounded-lg'>
                        <form action="">
                            <div className='grid grid-cols-2 gap-5'>
                                <input type="text" name="name" id="name" placeholder='Your Name...' className='border-b-[1px] border-brown-500 outline-none px-4 text-sm' />
