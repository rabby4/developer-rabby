        ...
        <>
            <div className='container max-w-7xl mx-auto lg:px-0 md:px-10 px-5'>
                ...
                <div className='space-y-10'>
                    <div className='flex md:flex-row flex-col gap-10 p-10 border-[1px] border-brown-900 border-opacity-20 rounded-lg'>
                        <div className='md:w-1/6 w-1/2'>
                            <img src={foodImg} alt="" />
                        </div>
                        <div className='md:w-5/6 space-y-4'>

                            <div className='flex justify-between md:flex-row flex-col md:space-y-0 space-y-4'>
                                <h2 className='lg:text-4xl md:text-3xl text-2xl font-bold text-brown-900'>Community food share</h2>
                    ...
                    <div className='flex md:flex-row flex-col gap-10 p-10 border-[1px] border-brown-900 border-opacity-20 rounded-lg'>
                        ...
                        <div className='md:w-5/6 space-y-4'>
                            ...
                            <div className='flex justify-between md:flex-row flex-col md:space-y-0 space-y-4'>
                                <h2 className='lg:text-4xl md:text-3xl text-2xl font-bold text-brown-900'>Wedding Matrimony</h2>
                    ...
                    <div className='flex md:flex-row flex-col gap-10 p-10 border-[1px] border-brown-900 border-opacity-20 rounded-lg'>
                        ...
                        <div className='md:w-5/6 space-y-4'>
                            <div className='flex justify-between md:flex-row flex-col md:space-y-0 space-y-4'>
                                <h2 className='lg:text-4xl md:text-3xl text-2xl font-bold text-brown-900'>Electronic Brand Shop</h2>
